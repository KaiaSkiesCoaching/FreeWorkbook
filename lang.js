...
const TRANSLATIONS = {
  ...
  en: {
    ...
    hero: {
      ...
      sub:     'You deserve to travel without anxiety holding you back. Start with the free workbook "The Fearless Flyer" — a gentle, evidence-based approach that transforms fear into freedom, one flight at a time.',
    ...
    wb: {
      badge:    '100% Free',
      meta:     '14 pages · Tools 1 & 2 of 7',
      bookSub:  'A Workbook by Kaia Skies',
      titleL1:  'Your <em>free workbook</em>',
      titleL2:  'is waiting',
      lead:     '"The Fearless Flyer" is a beautifully crafted, printable workbook that gets you started today — the first two tools of the full programme, completely free.',
      b1:       'Map your personal fear profile and pinpoint what actually triggers you',
      b2:       'A 2-minute calming quick win you can feel working immediately',
      b3:       'The fear loop explained — why your brain sounds a false alarm in the air',
      b4:       'Your 5-stage journey map, so you always know where you are',
      cta:      'Download Free'
    },
    full: {
      label:    'Coming Soon',
      badge:    'Coming Soon',
      bookSub:  'Complete Edition · Coming Soon',
      titleL1:  'The <em>Complete Edition</em>',
      titleL2:  'is on final approach',
      lead:     'The full Fearless Flyer programme: 58 pages, all 7 tools, and a dedicated chapter for every fear that keeps you on the ground.',
      b1:       'The complete 7-tool toolkit — from breathwork to your personal exposure ladder',
      b2:       'Deep chapters on the four core fears: loss of control, turbulence, crashing, and panic on board',
      b3:       '"When News Fuels Fear" — staying calm in a world of alarming headlines',
      b4:       'The Top 20 flight anxiety questions, answered',
      b5:       'A cut-out Flight Anxiety Emergency Card for your pocket',
      noticeTitle: 'Be the first to board',
      notice:   'Get the free workbook now and you will automatically receive an email the moment the Complete Edition launches — including a special launch price reserved for subscribers.',
  ...
  de: {
    ...
    hero: {
      ...
      sub:     'Du verdienst es, zu reisen – ohne dass Angst dich zurückhält. Starte mit dem kostenlosen Workbook „The Fearless Flyer": ein einfühlsamer, wissenschaftlich fundierter Ansatz, der Flugangst Schritt für Schritt in echte Freiheit verwandelt.',
    ...
    wb: {
      badge:    '100 % kostenlos',
      meta:     '14 Seiten · Tool 1 & 2 von 7',
      bookSub:  'Ein Workbook von Kaia Skies',
      titleL1:  'Dein <em>kostenloses Workbook</em>',
      titleL2:  'wartet auf dich',
      lead:     '„The Fearless Flyer" ist ein sorgfältig gestaltetes, druckbares Workbook, mit dem du noch heute startest – die ersten zwei Tools des kompletten Programms, ganz kostenlos.',
      b1:       'Erstelle dein persönliches Angstprofil und erkenne deine echten Auslöser',
      b2:       'Ein 2-Minuten-Quick-Win zur Beruhigung, den du sofort spürst',
      b3:       'Die Angstschleife erklärt – warum dein Gehirn in der Luft falschen Alarm schlägt',
      b4:       'Deine Journey-Map mit 5 Etappen – du weißt immer, wo du gerade stehst',
      cta:      'Jetzt gratis sichern'
    },
    full: {
      label:    'Bald verfügbar',
      badge:    'Coming Soon',
      bookSub:  'Complete Edition · Bald verfügbar',
      titleL1:  'Die <em>Complete Edition</em>',
      titleL2:  'ist im Landeanflug',
      lead:     'Das komplette Fearless-Flyer-Programm: 58 Seiten, alle 7 Tools und ein eigenes Kapitel für jede Angst, die dich am Boden hält.',
      b1:       'Das vollständige 7-Tool-Toolkit – von Atemtechniken bis zu deiner persönlichen Exposure Ladder',
      b2:       'Eigene Kapitel zu den vier Kernängsten: Kontrollverlust, Turbulenzen, Absturzangst und Panik an Bord',
      b3:       '„When News Fuels Fear" – gelassen bleiben in einer Welt voller Schlagzeilen',
      b4:       'Die Top 20 Fragen bei Flugangst, fundiert beantwortet',
      b5:       'Emergency Card zum Ausschneiden – für die Hosentasche, falls es eng wird',
      noticeTitle: 'Sei beim Start an Bord',
      notice:   'Hol dir jetzt das kostenlose Workbook – du bekommst automatisch eine E-Mail zum Launch der Complete Edition, inklusive Special Launch Price exklusiv für Abonnenten.',
